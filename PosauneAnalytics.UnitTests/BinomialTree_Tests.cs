...
namespace PosauneAnalytics.UnitTests
{
    ...
    public class BinomialTree_Tests
    {
        ...
        public void BinomialTree_Test()
        {
            ...
            callTree.AssetPrice = 100.00;
            callTree.Strike = 100.00;
            callTree.PutCall = EPutCall.Call;
            callTree.RiskFreeRate = 0.05d;
            callTree.Volatility = 0.25d;
            callTree.Steps = 55;
            ...
            putTree.AssetPrice = 25.00;
            putTree.Strike = 25.00;
            putTree.PutCall = EPutCall.Put;
            putTree.RiskFreeRate = 0.08d;
            putTree.Volatility = 0.35d;
            putTree.Steps = 3;
            putTree.TimeStep = .75;
