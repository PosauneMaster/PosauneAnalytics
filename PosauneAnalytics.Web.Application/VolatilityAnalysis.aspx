                ...
                <td style="vertical-align:top;">
                    <div id="analysis-date">
                        <table>
                            ...
                            <tr><td><div style="padding-top:16px; text-align:right;"><asp:Button runat="server" ID="btnRunAnalysis" CssClass="btn btn-primary btn-sm" Text="Run Analysis" OnClick="btnRunAnalysis_Click" /></div></td></tr>
                        </table>
                    </div>
                </td>
                <td>
